...
//// check equiprobability different hierarchy
/////////////////////////////////////////////////////////
{
...
#include<TFile>    
    ...
    //input neutrino normal hierarchy L=810
    ...
    //input neutrino inverted hierarchy L=810
   ...
   // x[0]=2.0+epsilon;
    ...
    ///////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////
    //neutrino w L = 810km normal hierarchy
    ...
    //neutrino w L =810km inverted hierarchy
	for (Int_t ix=0; ix < npointsx+1; ix++){
		double ptheta13 = ix*(xmax-xmin)/npointsx;
        for (Int_t iy=0; iy < npointsy+1; iy++){
			double pcp = iy*(ymax-ymin)/npointsy;
	...
	leg->AddEntry(h1equiprob,"Neutrino normal hierarchy","l");
    leg->AddEntry(h2equiprob,"Neutrino inverted hierarchy","l");
    ...
    leg->Draw("same");
    canvas1->Update();
    canvas1->Print("../plots/equiprob_"+fprob+"_1cont_diffHier.eps");
    canvas1->Print("../plots/equiprob_"+fprob+"_1cont_diffHier.pdf");
		
    
    TFile *poutFile = new TFile("../plots/equiprob_"+fprob+"_1cont_diffHier.root","RECREATE");
