...
#include<TFile>    
    ...
    TFile *poutFile = new TFile("../plots/equiprob_"+fprob+"_3cont.root");
    ...
    //brow
    Int_t ci2 = TColor::GetColor("#663300");
    //navy blue
    Int_t ci3 = TColor::GetColor("#006699");
    h1equiprob->SetLineColor(ci1);
    h2equiprob->SetLineColor(ci2);
    h3equiprob->SetLineColor(ci3);
	...
	leg->AddEntry(h1equiprob,"P(#nu_{#mu}#rightarrow #nu_{e})=0.05","l");
    leg->AddEntry(h3equiprob,"P(#nu_{#mu}#rightarrow #nu_{e})=0.06","l");
    leg->AddEntry(h2equiprob,"P(#nu_{#mu}#rightarrow #nu_{e})=0.07","l");
    ...
    //leg->AddEntry(MuElec_right,Th13StrR,"l");
			...
			canvas1->cd();
			Int_t colors[]={ci1,ci2,ci3};
			gStyle->SetPalette((sizeof(colors)/sizeof(Int_t)), colors);
			Double_t levels[]={0.05,0.06,0.07};
            ...
            leg->Draw("same");
			canvas1->Update();
			canvas1->Print("../plots/equiprob_"+fprob+"_3cont.eps");
			canvas1->Print("../plots/equiprob_"+fprob+"_3cont.pdf");
