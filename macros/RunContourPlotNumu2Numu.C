...
#include<TFile>    
    ...
    //savename
    TString fcont="cont_";
    TString fprob="model3flav_vac_apx_nocp_MuSurvive";
    ...
    for (Int_t ix=0; ix < npointsx+1; ix++){
        for (Int_t iy=0; iy < npointsy+1; iy++){
            ...
            SetOscParam(par);
            hcont_nu_norm->SetBinContent(ix,iy, model3flav_vac_apx_nocp_MuSurvive(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx+1; ix++){
        for (Int_t iy=0; iy < npointsy+1; iy++){
            ...
            SetOscParam(par);
            hcont_nu_invt->SetBinContent(ix,iy, model3flav_vac_apx_nocp_MuSurvive(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx+1; ix++){
        for (Int_t iy=0; iy < npointsy+1; iy++){
            ...
            SetOscParam(par);
            hcont_antinu_norm->SetBinContent(ix,iy, model3flav_vac_apx_nocp_MuSurvive(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx+1; ix++){
        for (Int_t iy=0; iy < npointsy+1; iy++){
            ...
            SetOscParam(par);
            hcont_antinu_invt->SetBinContent(ix,iy, model3flav_vac_apx_nocp_MuSurvive(x));
        }
    }
