...
#include<TFile>    
    ...
    gROOT->ProcessLine(".L TestNewProb.C+");
    ...
    TLatex* tlx=new TLatex(0.6, 0.85,legStr32+delMStr32);
    ...
    TLatex* tlx1=new TLatex(0.6, 0.80,legStr21+delMStr21);
    ...
    TLatex* tlx2=new TLatex(0.6, 0.75,Th23Str);
    ...
    TLatex* tlx3=new TLatex(0.6, 0.70,Th12Str);
    ...
    TLatex* tlx7=new TLatex(0.67, 0.45,NorHierStr);
    ...
    TLatex* tlx8=new TLatex(0.25, 0.6,InvHierStr);
    ...
    //pmuex[dcpstep+2]=pmuex[0];
    //pmuey[dcpstep+2]=pmuey[0];
    ...
    tlx8->Draw("same");
    leg->Draw("same");
    canvas1->Print("plots/elec_appe"+fprob+LStrname+".eps");
    canvas1->Print("plots/elec_appe"+fprob+LStrname+".pdf");
    canvas1->Print("plots/elec_appe"+fprob+LStrname+".png");
    
    TFile *poutFile = new TFile("plots/elec_appe"+fprob+LStrname+".root","RECREATE");
    MuElec->Write("MuElec");
    MuElecInv->Write("MuElecInv");
    MuEleccp0->Write("MuEleccp0");
    MuElecInvcp0->Write("MuElecInvcp0");
    MuEleccp12->Write("MuEleccp12");
    MuElecInvcp12->Write("MuElecInvcp12");
    MuEleccp1->Write("MuEleccp1");
    MuElecInvcp1->Write("MuElecInvcp1");
    MuEleccp32->Write("MuEleccp32");
    MuElecInvcp32->Write("MuElecInvcp32");
    poutFile->Close();
