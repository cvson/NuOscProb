...
#include<TFile>    
    ...
    //savename
    TString fcont="cont_";
    TString fprob="model3flav_mat_ElecToElec";
    ...
    for (Int_t ix=0; ix < npointsx; ix++){
        for (Int_t iy=0; iy < npointsy; iy++){
            ...
            SetOscParam(par);
            hcont_nu_norm->SetBinContent(ix,iy, model3flav_mat_ElecToElec(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx; ix++){
        for (Int_t iy=0; iy < npointsy; iy++){
            ...
            SetOscParam(par);
            hcont_nu_invt->SetBinContent(ix,iy, model3flav_mat_ElecToElec(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx; ix++){
        for (Int_t iy=0; iy < npointsy; iy++){
            ...
            SetOscParam(par);
            hcont_antinu_norm->SetBinContent(ix,iy, model3flav_mat_ElecToElec(x));
        }
    }
    ...
    for (Int_t ix=0; ix < npointsx; ix++){
        for (Int_t iy=0; iy < npointsy; iy++){
            ...
            SetOscParam(par);
            hcont_antinu_invt->SetBinContent(ix,iy, model3flav_mat_ElecToElec(x));
        }
    }
