...
#include<TString>
    ...
    */
    ...
    TLatex* tlx5=new TLatex((isNOVA? 0.6:0.65)+xshift, 0.60+yshift,LStr);
    tlx5->SetNDC(kTRUE); // <- use NDC coordinate
    tlx5->SetTextSize(0.04);
    tlx5->SetTextAlign(12);
    
    TString EnStr=Form("E_{#nu}=%2.1f GeV",ent2k);
    TLatex* tlx6=new TLatex((isNOVA? 0.6:0.65)+xshift, 0.55+yshift,EnStr);
    ...
    TLatex* tlx7=new TLatex(isNOVA? 0.67:0.72, isNOVA? 0.38:0.45,NorHierStr);
    ...
    TLatex* tlx8=new TLatex(isNOVA? 0.25:0.3, isNOVA? 0.6:0.66,InvHierStr);
    ...
    for (Int_t i=0; i < dcpstep+1; i++){
        ...
        myProb.SetTh12(myTheta12);
        myProb.SetTh23(myTheta23highOc);
        myProb.SetTh13(myTheta13);
        myProb.SetdCP(vdcp);
        myProb.SetMix(myProb.GetTh12(),myProb.GetTh23(),myProb.GetTh13(),myProb.GetdCP());
        myProb.SetDeltaMsqrs(myProb.GetDmsq21(),myProb.GetDmsq32());
        
        pmuehighx[i]=myProb.P(isAnti*14,isAnti*12,ent2k);
        //cout<< "cp "<<myProb.GetdCP() <<" prob "<< pmuehighx[i] <<endl;
    ...
    for (Int_t i=0; i < dcpstep+1; i++){
        ...
        myProb.SetMix(myProb.GetTh12(),myProb.GetTh23(),myProb.GetTh13(),myProb.GetdCP());
        myProb.SetDeltaMsqrs(myProb.GetDmsq21(),myProb.GetDmsq32());
        pmuehighy[i]=myProb.P(isAnti*14,isAnti*12,ent2k);
        
    }
    
    MuElechighOct = new TGraph(dcpstep,pmuehighx,pmuehighy);
    ///////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////
    // inverted hierarchy
    ...
    for (Int_t i=0; i < dcpstep+1; i++){
        ...
        myProb.SetMix(myProb.GetTh12(),myProb.GetTh23(),myProb.GetTh13(),myProb.GetdCP());
        myProb.SetDeltaMsqrs(myProb.GetDmsq21(),myProb.GetDmsq32());
        pmuehighxInv[i]=myProb.P(isAnti*14,isAnti*12,ent2k);
    }
    //Anti neutrino
    isAnti=-1;
    for (Int_t i=0; i < dcpstep+1; i++){
        ...
        myProb.SetMix(myProb.GetTh12(),myProb.GetTh23(),myProb.GetTh13(),myProb.GetdCP());
        myProb.SetDeltaMsqrs(myProb.GetDmsq21(),myProb.GetDmsq32());
        pmuehighyInv[i]=myProb.P(isAnti*14,isAnti*12,ent2k);
    }
    
    MuElechighOctInv = new TGraph(dcpstep,pmuehighxInv,pmuehighyInv);
    ...
    tlx8->Draw("same");
    leg->Draw("same");
    canvas1->SaveAs(isNOVA?"../plots/nova_octant_elec_appearance_biprobability.eps":"../plots/t2k_octant_elec_appearance_biprobability.eps");
