...
//// check equiprobability different hierarchy & different octant
/////////////////////////////////////////////////////////
{
...
#include<TFile>    
   ...
   // x[0]=2.0+epsilon;
    ...
    TFile *poutFile = new TFile("plots/equiprob_"+fprob+"_1cont_diffHier_diffOcta.root");
    TH2F* hequiprob=(TH2F*)poutFile->Get("hequiprob");
    TH2F* hequiprobInv=(TH2F*)poutFile->Get("hequiprobInv");
    TH2F* hequiprobhigh=(TH2F*)poutFile->Get("hequiprobhigh");
    TH2F* hequiprobInvhigh=(TH2F*)poutFile->Get("hequiprobInvhigh");
	...
	leg->AddEntry(h1equiprob,"Normal hierarchy & #theta_{23}<45^{o}","l");
    leg->AddEntry(h2equiprob,"Inverted hierarchy & #theta_{23}<45^{o}","l");
    leg->AddEntry(h3equiprob,"Normal hierarchy & #theta_{23}>45^{o}","l");
    leg->AddEntry(h4equiprob,"Inverted hierarchy & #theta_{23}>45^{o}","l");
    ...
    Double_t levelsInvhigh[]={0.0,problevelL2high};
    ...
    leg->Draw("same");
    canvas1->Update();
    canvas1->Print("plots/equiprob_"+fprob+"_1cont_diffHier_diffOcta.eps");
    canvas1->Print("plots/equiprob_"+fprob+"_1cont_diffHier_diffOcta.pdf");
