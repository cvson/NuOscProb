...
#include<TString>
    ...
    //gROOT->ProcessLine(".L /Users/cvson/Box\ Sync/meNotes/threeFlavor/NuOscProb/source/OscCalculatorPMNS.C+");
    ...
    */
    ...
    leg->Draw();
    canvas1->SaveAs("../plots/threeflav_exact_probability_vacuum.eps");
